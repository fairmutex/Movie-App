import { TestBed, inject, async } from "../../../node_modules/@angular/core/testing";
...
describe('MovieService', () => {
    beforeEach(() => {
        TestBed.configureTestingModule({
            ...
            imports: [HttpClientTestingModule,  HttpClientInMemoryWebApiModule.forRoot(MovieData, { delay: 0 })]
        });
    });
    ...
    it('should get deadpool record', inject([MovieService], (service: MovieService) => {
    ...
    it('should search deadpool', inject([MovieService], (service: MovieService) => {
        spyOn(service, 'getMovies').and.callThrough();
    ...
    it('should get comedy genre', inject([MovieService], (service: MovieService) => {
        spyOn(service, 'getMovies').and.callThrough();
